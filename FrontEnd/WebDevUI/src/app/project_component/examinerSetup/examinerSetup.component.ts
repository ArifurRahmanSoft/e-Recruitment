...
@Component({
  selector: 'app-examiner-setup',
  templateUrl: './examinerSetup.component.html',
  styleUrls: ['./examinerSetup.component.scss'],
  providers: [PagerService]
})
export class ExaminerSetupComponent implements OnInit {
   ...
   constructor(
       ...
       this._pathValidation.alterCmnBtn([{ id: 1, col: "btnName", val: 'Create Examiner' }]);
       this._pathValidation.alterCmnBtn([{ id: 2, col: "btnName", val: 'Update Examiner' }]);
   ...
   public _getUrl: string = 'candidateinfo/getexaminarbypages';
       ...
       this._dataservice.getWithMultipleModel(apiUrl, param)
           .subscribe(
               response => {
                   ...
                   if (this.res.resdata.listExaminar.length > 0) {
                       this.userList = JSON.parse(this.res.resdata.listExaminar);
    ...
    debugger
       ...
       this._dataservice.postMultipleModel(apiUrl, ModelsArray)
           .subscribe(response => {
               ...
               if (this.res.resdata) {
                   this.getByPage(0, true, this.pageSize);
                   if (this.res.resdata.status == 'error') {
